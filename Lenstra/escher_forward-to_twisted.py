...
if __name__ == "__main__":
   ...
   resolution = 8            # larger number means more output pixels
   zoom = 3              # this value can be used to zoom in our out of the generated image
   ...
   path = '/Users/lucia/Desktop/Escher_Project/00-CODIGOS/0000-Cris Luengo/00-Latest_code-Lucia/Results/LaMa2048/Filled'
   ii = 0
   ...
   rot_angle = 0.65 # 0.65  # experimental
